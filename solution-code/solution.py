...
def compare_models(prompt: str) -> dict:
    ...
    # Call 3 models
    openai_text, openai_latency, openai_usage = call_openai(prompt, model=OPENAI_MODEL)
    ...
    # Calculate cost
    def calc_cost(model_key, usage):
        p = PRICING_1M_TOKENS[model_key]
    ...
    return {
        "gpt4o": {
            ...
            "cost": calc_cost("gpt-4o", openai_usage),
...
def streaming_chatbot() -> None:
    ...
    while True:
        ...
        # Giữ tối đa 3 lượt gần nhất (6 messages)
        history = history[-6:]
